...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<kramdown>.freeze, ["~> 1.3".freeze])
  s.add_runtime_dependency(%q<liquid>.freeze, ["~> 3.0".freeze])
  s.add_runtime_dependency(%q<mercenary>.freeze, ["~> 0.3.3".freeze])
  s.add_runtime_dependency(%q<pathutil>.freeze, ["~> 0.9".freeze])
  s.add_runtime_dependency(%q<rouge>.freeze, ["~> 1.7".freeze])
